...
void
fix_greedy(std::vector<GenePoint> &genome, std::vector<GenePoint> &example, bool isClosed, measures distance_measure) {
    int n = genome.size();
...
void
fix_greedy2(std::vector<GenePoint> &genome, std::vector<GenePoint> &example, bool isClosed, measures distance_measure) {
    int n = genome.size();
